...
- Import / export ratings for backup, device transfer, and Group Merge
...
- Optional "Copy DJ name to clipboard" toggle in Play overlay (stored locally and included in export)
- Favorites view
...
Local-only group analysis for multiple export JSONs exported from the planner:
...
- Play preferences (default platform + copy-name toggle) stored locally (localStorage)
